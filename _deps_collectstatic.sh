...
cp bower_components/lodash/dist/lodash.js dockci/static/lib/js/lodash.js
cp bower_components/msgpack-lite/dist/msgpack.min.js dockci/static/lib/js/msgpack.js
